...
export default function EndOfClassFeedback({ classId }: { classId: string }) {
  ...
  async function copyClassSummaryToClipboard() {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6 p-4 border border-input rounded-lg bg-card">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-semibold">Class Summary (Optional)</h3>

            {/* NEW: Copy to Clipboard Button */}
            <button
              onClick={copyClassSummaryToClipboard}
              disabled={!classSummary && !homework}
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                copied
                  ? "bg-green-600 text-white"
                  : classSummary || homework

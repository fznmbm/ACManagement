      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: "https://al-hikmah.org/",
            logo: "https://al-hikmah.org/logo.png",
            image: "https://al-hikmah.org/og-image.png",
            foundingDate: "2018",
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    ...
                    name: "Quran Classes",
                    description:
                      "Comprehensive Quran recitation and memorization with proper Tajweed",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    ...
                    description:
                      "In-depth study of Islamic principles, history, and values",
                  },
                },
                {
                  "@type": "Offer",
          ...
          <div className="container mx-auto px-4 py-20 md:py-32">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">
                We provide comprehensive Islamic education for children,
                combining Quranic studies, Arabic language, and Islamic values
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                Comprehensive Islamic education tailored for different age
                groups
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="group p-8 bg-card rounded-lg border shadow-sm hover:shadow-lg transition-all hover:border-primary">
                ...
                <p className="text-muted-foreground mb-4">
                  Comprehensive Islamic education covering Aqeedah, Fiqh,
                  Seerah, and Akhlaq.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start text-sm">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Experienced educators with strong Islamic knowledge and
                  teaching skills
                </p>
              </div>

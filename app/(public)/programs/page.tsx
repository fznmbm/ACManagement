          ...
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Our comprehensive Quran program focuses on proper recitation,
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Age-appropriate explanation of Quranic verses and their
                        meanings
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  A comprehensive Islamic education covering beliefs, practices,
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold mb-1">Aqeedah (Beliefs)</h4>
                      <p className="text-sm text-muted-foreground">
                        Understanding the six pillars of Iman and Islamic creed
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold mb-1">Seerah (Biography)</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold mb-1">Akhlaq (Character)</h4>
                      <p className="text-sm text-muted-foreground">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Learn to read, write, and understand Arabic - the language of
                  the Quran and Islamic scholarship.
                </p>
              ...
              <div className="bg-muted/50 rounded-lg p-8">
                ...
                <div className="mt-6 pt-6 border-t">
                  ...
                  <p className="text-sm">Beginners to intermediate learners</p>
                </div>
              </div>
            </div>
          </div>

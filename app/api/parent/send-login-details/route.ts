...
<div style="background-color: #eff6ff; border-left: 4px solid #3b82f6; padding: 15px; margin: 20px 0;">
  ...
  <p style="margin: 5px 0; background-color: #dbeafe; padding: 10px; border-radius: 5px;">
    ...
    If you've previously set up your password, simply <a href="${process.env.NEXT_PUBLIC_APP_URL}/parent/login" style="color: #2563eb; font-weight: bold;">log in with your existing credentials</a>.
  </p>
